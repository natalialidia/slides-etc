...
\begin{frame}
    ...
    \begin{lemma} \label{lem:points}
        $(x_S,x_{\bar S},y)$ é um ponto inteiro em $\PxG$ $\iff$ $(\e-x_S,x_{\bar S},y)$ é um ponto inteiro em $\Px(G^S)$.
    \end{lemma}
    \pause
...
\begin{frame}
    ...
    \begin{proposition}\label{prop:valid}
        ...
        \pause
        \begin{itemize}
            \item $\pi_S x_S + \pi_{\bar S} x_{\bar S} + \lambda y \leq \pi_0$ é válida para $\PxG$ $\iff $ $\pi_S(\e -x_S) + \pi_{\bar S} x_{\bar S} +  \lambda y \leq \pi_0$ é válida para $\Px(G^S)$.\\[0.5em]
            \pause
    ...
    \begin{theorem}\label{teo:valid-comutacao-parcial}
        ...
        \begin{itemize}
            ...
            \pause
            \item $\pi_S x_S + \pi_{\bar S} x_{\bar S} + \lambda_{E(H)} y_{E(H)} \leq \pi_0$ induz faceta de $\PxG$ $\iff$ $\pi_S(\e -x_S) + \pi_{\bar S} x_{\bar S} +  \lambda_{E(H)} y_{E(H)} \leq \pi_0$ induz faceta de $\Px(G')$.
        \end{itemize}
    \end{theorem}
