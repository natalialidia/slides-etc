...
\begin{frame}
    ...
    e $L_G(x,y) = \pi_S x_S + \pi_{\bar S} x_{\bar S} + \lambda_{E(G)} y_{E(G)}$:
    ...
    \begin{theorem}\label{teo:valid-comutacao-parcial}
        \begin{itemize}
            \item $H$ é subgrafo de $G$ e $H^S$ é subgrafo de $G'$. \\[0.5em]
            \pause
            \item $L_H(x_S, x_{\bar S},y) \leq \pi_0$ induz faceta de $\PxG$ $\iff$ $L_H(\m{1} -x_S,x_{\bar S},y) \leq \pi_0$ induz faceta de $\Px(G')$.
        \end{itemize}
    \end{theorem}
